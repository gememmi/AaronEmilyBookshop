...
function About (){
   ...
   <div className="about" style={{textAlign: "center", lineHeight: "2", fontSize: "18px", padding: "20px", fontFamily: "Noto Serif Oriya", backgroundColor: "#b14848", borderRadius:"15px"}}>


   
   <p className="about-para">
         Welcome to Aaron & Emily's Book Shop!
